        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CHK_Producto_Precio", "Precio >= 0");
                    table.CheckConstraint("CHK_Producto_Stock", "Stock >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CHK_Detalle_Cantidad", "Cantidad > 0");
                    table.CheckConstraint("CHK_Detalle_Descuento", "Descuento >= 0");
                    table.ForeignKey(
